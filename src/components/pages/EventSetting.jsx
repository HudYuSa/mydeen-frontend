...
const EventSetting = () => {
  ...
  const updateEventDateFormik = useFormik({
    initialValues: {
      date: formatTime(event.startDate).split(" ")[1],
      time: formatTime(event.startDate).split(" ")[0].slice(0, -3),
    },
    validationSchema: Yup.object({
  ...
  const toggleUpdateNamePopup = () => {
    setUpdateNamePopup((prev) => {
      return !prev;
    });
  };
  const toggleUpdateDatePopup = () => {
    setUpdateDatePopup((prev) => {
      return !prev;
    });
  };
    ...
    <div className="flex min-h-screen w-full flex-col bg-mainBackground">
      ...
      <main className="mx-auto w-full max-w-2xl">
        ...
        <Popup
          ...
          togglePopup={toggleUpdateNamePopup}
          content={
            <UpdateEventName
              formik={updateEventNameFormik}
              toggleUpdateNamePopup={toggleUpdateNamePopup}
            />
          }
        />
        ...
        <Popup
          ...
          togglePopup={toggleUpdateDatePopup}
          content={
            <UpdateEventDate
              formik={updateEventDateFormik}
              toggleUpdateDatePopup={toggleUpdateDatePopup}
            />
          }
        />
